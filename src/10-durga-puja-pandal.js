...
export function filterPandalsByZone(container, zone) {
  ...
  return Array.from(container.querySelectorAll(".pandal")).filter((element) => element.dataset.zone === zone);
}
...
export function getPandalsByBudgetRange(container, min, max) {
  ...
  return Array.from(container.querySelectorAll(".pandal")).filter((element) => {
...
export function sortPandalsByRating(container) {
  ...
  const pandals = Array.from(container.querySelectorAll(".pandal")).sort(
